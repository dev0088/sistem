...
<html lang="en-us" <?php echo implode(' ', array_map(function($prop, $value) {
	...
	<head>
		...
		<title> <?php echo $page_title != "" ? $page_title." - " : ""; ?>Sistema M3 </title>
        ...
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/froala_editor.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/froala_style.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/code_view.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/colors.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/emoticons.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/image_manager.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/image.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/line_breaker.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/table.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/file.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/char_counter.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/video.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/emoticons.css">
        <link rel="stylesheet" href="<?php echo ASSETS_URL; ?>/css/plugins/fullscreen.css">
		...
		?>
				...
				<header id="header">
					<div id="logo-group">
						...
						<span id="logo"> <a href="<?php echo ASSETS_URL; ?>index.php"><img src="<?php echo ASSETS_URL; ?>/img/logo.png" alt="logo"> </a></span>
					...
					<div class="pull-right">
						...
						<div id="logout" class="btn-header transparent pull-right">
							<span> <a href="<?php echo APP_URL; ?>/logout.php" title="Sign Out" data-action="userLogout" data-logout-msg="Adem&aacute;s de salir del sistema le sugerimos cerrar su navegador"><i class="fa fa-sign-out"></i></a> </span>
						</div>
						<!-- end logout button -->
...
<!--						<form action="<?php// echo APP_URL; ?>/search.php" class="header-search pull-right">
							<input type="text" name="param" placeholder="Búsqueda" id="search-fld">
							<button type="submit">
...
-->						<li>
							<a href="<?php echo APP_URL; ?>profile.php" class="jarvismetro-tile big-cubes selected bg-color-pinkDark"> <span class="iconbox"> <i class="fa fa-user fa-4x"></i> <span>Mi perfil </span> </span> </a>
						</li>
					</ul>
				</div>
				<!-- END SHORTCUT AREA -->
