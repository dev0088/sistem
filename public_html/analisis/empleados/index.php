<?php 
    ...
    $pageURL 		= APP_URL . 'analisis/empleados/index.php';
	$breadcrumbs["Analisis"] = '';
    $page_nav["Analisis"]['sub']["Empleados"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-employee').on('click', function() {
            location.href = "<?= APP_URL ?>analisis/empleados/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-employee').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empleados/home.php?employee_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
        ...
        $('.btn-view-employee').on('click', function() {
            var 
                selectedCompanyId = $('.employee-row.selected:first').data('employeeId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empleados/home.php?employee_id=" + selectedCompanyId + "&page=view";
            }
        });
