<?php
	...
	$breadcrumbs["Analisis"] = APP_URL . 'analisis/empresas/index.php';
	$breadcrumbs["Expedientes"] = '';
    $pageURL 		= APP_URL . 'analisis/empleados/modificar.php';
	$page_title 	= "Modificar expediente";
	$page_css[] 	= "wizard.css";
	$page_nav["Analisis"]["sub"]["Empleados"]["sub"]["Modificar expediente"]["active"] 	= true;
