...
/**********************************************  PAGE SPECIFICS  ************************************************/
	...
	$db->connect();
    $pageURL 	= APP_URL . 'analisis/propuesta/detalle.php';
	$page_nav["Analisis"]["sub"]["Propuestas"]["sub"]["Detalle propuesta"]["active"] 	= true;
	$breadcrumbs["Analisis"] = '';
	$breadcrumbs["Propuestas"] = APP_URL . 'analisis/propuesta/home.php';
