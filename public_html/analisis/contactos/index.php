<?php 
    ...
    $pageURL 		= APP_URL . 'analisis/contactos/index.php';
	$breadcrumbs["Analisis"] = '';
    $page_nav["Analisis"]['sub']["Contactos"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-contacto').on('click', function() {
            location.href = "<?= APP_URL ?>analisis/contactos/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-contacto').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/contactos/home.php?contacto_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
