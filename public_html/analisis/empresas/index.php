...
/**********************************************  PAGE SPECIFICS  ************************************************/
    ...
    $pageURL 			= APP_URL . 'analisis/empresas/index.php';
	$breadcrumbs["Análisis"] = APP_URL . 'analisis/empresas/home.php';
    $page_nav["Analisis"]["sub"]["Empresas"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-company').on('click', function() {
            location.href = "<?= APP_URL ?>analisis/empresas/home.php?page=insert";
        });
        ...
        $('.btn-view-company').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empresas/home.php?company_id=" + selectedCompanyId + "&page=detail";
            }
        });
        ...
        $('.btn-edit-company').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empresas/home.php?company_id=" + selectedCompanyId + "&page=edit";
            }
        });
        ...
        $('.btn-estatus-company').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empresas/home.php?company_id=" + selectedCompanyId + "&page=status";
            }
        });
        ...
        $('.btn-company-contactos').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/contactos/home.php?company_id=" + selectedCompanyId;
            }
        });
        ...
        $('.btn-company-citas').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/citas/home.php?company_id=" + selectedCompanyId;
            }
        });
        ...
        $('.btn-company-propuestas').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/propuesta/home.php?company_id=" + selectedCompanyId;
            }
        });
        ...
        $('.btn-company-employees').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>analisis/empleados/home.php?company_id=" + selectedCompanyId;
            }
        });
