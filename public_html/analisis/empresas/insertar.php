...
/**********************************************  PAGE SPECIFICS  ************************************************/
    $pageURL 	= APP_URL . 'empresas/empresas/insertar.php';
	$db 		= new Database(DB_SERVER, DB_USER, DB_PASS, DB_DATABASE);
	$db->connect();
    $page_nav["Analisis"]["sub"]["Empresas"]["sub"]["Agregar empresa"]["active"] = true;
	$breadcrumbs["Análisis"] 	= APP_URL . 'analisis/empresas/home.php';
    $page_title 				= "Nueva empresa";
	
	include ("../../empresas/process-insert.php");

/**********************************************  PAGE SPECIFICS  ************************************************/
    include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
	include ("../../empresas/content-insert.php");
