...
class GUMP
{
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_valid_email':
                    ...
                    break;
				 case 'validate_match':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field needs to match with password.";
                    break;
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_valid_email':
                    ...
                    break;
				case 'validate_match':
                    $resp[$field] = "The $field field needs to match with password";
                    break;
                case 'validate_max_len':
    ...
    */
	...
	protected function validate_match($field, $input, $param = null)
    {
        if (!isset($input[$field])) {
            return;
        }
