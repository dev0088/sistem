						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <tbody>
                                <?php if ( $arrOperando ) { ?>
                                    <?php foreach( $arrOperando as $objoperandoData ) { ?>
                                        <tr class="contacto-row" 
                                            <?php foreach( $objOperandoData as $key => $val) { ?>
                                            data-estatus-<?= $key ?>="<?= $val ?>"
                                            <?php } ?> >
                                            <td><?= ($objoperandoData['id']) ?></td>
											<td></td>
											<td></td>
                                            <td><?= $objoperandoData['nombre'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <tbody>
                                <?php if ( $arrOficializado ) { ?>
                                    <?php foreach( $arrOficializado as $objOficializado ) { ?>
                                        <tr class="contacto-row" 
                                            <?php foreach( $objOficializado as $key => $val) { ?>
                                            data-estatus-<?= $key ?>="<?= $val ?>"
                                            <?php } ?> >
                                            <td><?= ($objOficializado['id']) ?></td>
											<td></td>
											<td></td>
                                            <td><?= $objOficializado['nombre'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <tbody>
                                <?php if ( $arrclientesporOperar ) { ?>
                                    <?php foreach( $arrclientesporOperar as $objclientesporOperar ) { ?>
                                        <tr class="contacto-row" 
                                            <?php foreach( $objclientesporOperar as $key => $val) { ?>
                                            data-estatus-<?= $key ?>="<?= $val ?>"
                                            <?php } ?> >
                                            <td><?= ($objclientesporOperar['id']) ?></td>
											<td></td>
											<td></td>
                                            <td><?= $objclientesporOperar['nombre'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
						...
						<div>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <tbody>
                                <?php if ( $arrClientessin ) { ?>
                                    <?php foreach( $arrClientessin as $objClientessin ) { ?>
                                        <tr class="contacto-row" 
                                            <?php foreach( $objClientessin as $key => $val) { ?>
                                            data-estatus-<?= $key ?>="<?= $val ?>"
                                            <?php } ?> >
                                            <td><?= ($objClientessin['id']) ?></td>
											<td></td>
											<td></td>
                                            <td><?= $objClientessin['nombre'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
...
<!-- Widget ID (each widget will need unique ID)-->
				<div class="jarviswidget jarviswidget-color-blueDark" id="sin-programacion"
						...
						<header>
							<span class="widget-icon"> <i class="fa fa-table"></i> </span>
							<h2>Reporte de clientes por estatus</h2>
						</header>
							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <thead>
							            ...
							            <tr class="header-cols-labels">
						                    <th class="<?= $sortBy && ('description' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="description">Estatus</th>
											<th class="<?= $sortBy && ('description' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="description">Cantidad de empresas</th>
