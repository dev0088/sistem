...
/**********************************************  PAGE SPECIFICS  ************************************************/
    $page_title 		= "Suministradoras";
    $page_css[] 		= "companies.css";
    $pageURL 			= APP_URL . 'admin/suministradoras/index.php';
	$breadcrumbs["Admin"] = '';
    $page_nav["Usuarios"]["sub"]["Suministradoras"]["active"] = true;
	
	include ("../../suministradoras/process-index.php");
	include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
	include ("../../suministradoras/content-index.php");
?>
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-company').on('click', function() {
            location.href = "<?= APP_URL ?>admin/suministradoras/home.php?page=insert";
        });
        ...
        $('.btn-view-company').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>admin/suministradoras/home.php?company_id=" + selectedCompanyId + "&page=detail";
            }
        });
        ...
        $('.btn-edit-company').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>admin/suministradoras/home.php?company_id=" + selectedCompanyId + "&page=edit";
            }
        });
        ...
        $('.btn-remove-company').on('click', function() {
            ...
            if ( selectedCompanyId && confirm("Are you sure that you want to remove suministradoras?") ) {
