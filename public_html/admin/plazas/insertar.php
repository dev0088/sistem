<?php
	...
	$success	= "";
	$errors 	= array();
	$page_title = "Agregar plaza";
    $pageURL 	= APP_URL . 'admin/plazas/insertar.php';
	$page_css[] = "your_style.css";
    $page_nav["Usuarios"]["sub"]["Plazas"]["sub"]["Agregar plaza"]["active"] 	= true;
	$breadcrumbs["Admin"] = '';
	
	
	include ("../../plazas/process-insert.php");
	include("../../inc-2/header.php");
	include("../../inc-2/nav.php");
	include ("../../plazas/content-insert.php");
