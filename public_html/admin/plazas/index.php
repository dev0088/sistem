<?php 
    ...
    $pageURL 		= APP_URL . 'admin/plazas/index.php';
	$breadcrumbs["Admin"] = '';
    $page_nav["Usuarios"]['sub']["Plazas"]["active"] 	= true;
    
	include ("../../plazas/process-index.php");
    include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
    include ("../../plazas/content-index.php");
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-contacto').on('click', function() {
            location.href = "<?= APP_URL ?>admin/plazas/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-contacto').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>admin/plazas/home.php?contacto_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
        ...
        $('.btn-remove-contacto').on('click', function() {
			...
			{
                $('#contacto-details input[name="plaza_id"]').val(selectedCompanyId);
