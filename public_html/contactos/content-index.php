							...
							<div class="widget-body no-padding">
								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <thead>
										<tr>
											<th class="hasinput">
												<input type="text" class="form-control filter" data-field="id" placeholder="Contactos Id"<?= ($filters['id'] ? " value=\"{$filters['id']}\"" : "") ?> />
											</th>
											<th class="hasinput">
											...
											<th class="hasinput">
												<input type="text" class="form-control filter" data-field="puesto" placeholder="Puesto"<?= ($filters['puesto'] ? " value=\"{$filters['puesto']}\"" : "") ?> />
											</th>
											<th class="hasinput">
												<input type="text" class="form-control filter" data-field="telefono1" placeholder="Telefono 1"<?= ($filters['telefono1'] ? " value=\"{$filters['telefono1']}\"" : "") ?> />
											</th>
                                            <th class="hasinput">
												<input type="text" class="form-control filter" data-field="telefono2" placeholder="Telefono 2"<?= ($filters['telefono2'] ? " value=\"{$filters['telefono2']}\"" : "") ?> />
											</th>
                                            <th class="hasinput">
												<input type="text" class="form-control filter" data-field="correo" placeholder="Correo"<?= ($filters['correo'] ? " value=\"{$filters['correo']}\"" : "") ?> />
											</th>
                                            <th class="hasinput">
							            ...
							            <tr class="header-cols-labels">
						                    ...
						                    <th class="<?= $sortBy && ('puesto' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="puesto">Puesto</th>
						                    <th class="<?= $sortBy && ('telefono1' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="telefono1">Telefono 1</th>
                                            <th class="<?= $sortBy && ('telefono2' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="telefono2">Telefono 2</th>
                                            <th class="<?= $sortBy && ('correo' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="correo">Correo</th>
                                ...
                                <?php if ( $arrCompaniesData ) { ?>
                                    <?php foreach( $arrCompaniesData as $objCompanyData ) { ?>
                                        <tr class="contacto-row" 
                                            ...
                                            <td><?= $objCompanyData['puesto'] ?></td>
                                            <td><?= $objCompanyData['telefono1'] ?></td>
                                            <td><?= $objCompanyData['telefono2'] ?></td>
                                            <td><?= $objCompanyData['correo'] ?></td>
                                            <td><?= $objCompanyData['notas'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
                                ...
                                <div class="dt-toolbar-footer">
                                    ...
                                    <div class="col-sm-4 col-xs-12">
                                        <button class="btn btn-sm btn-success btn-add-contacto">
                                            <i class=" fa fa-plus"></i> Agregar
                                        </button> &nbsp;
                                        <button class="btn btn-sm btn-default btn-edit-contacto">
                                             <i class="fa fa-pencil"></i> Editar
                                        </button> &nbsp;
                                        <button class="btn btn-sm btn-default btn-remove-contacto">
			...
			<div class="modal-dialog">
				<form class="modal-content" method="POST">
					<div class="modal-header">
						...
						<h4 class="modal-title" id="myModalLabel">Contacto Details</h4>
					</div>
					...
					<div class="modal-footer">
                        ...
                        <input type="hidden" name="contactos_id" value="" />
