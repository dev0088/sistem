								...
								<table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
							        ...
							        <thead>
							            <tr class="header-cols-labels">
						                    ...
						                    <th class="<?= $sortBy && ('apoderado' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="apoderado">Apoderado Legal</th>
							            </tr>
										<tr>
											<th class="hasinput">
											...
											<th class="hasinput">
												<input type="text" class="form-control filter" data-field="apoderado" placeholder="Apoderado Legal"<?= ($filters['apoderado'] ? " value=\"{$filters['apoderado']}\"" : "") ?> />
											</th>
										</tr>
							        </thead>
								...
								?>
									...
									?>
                                        <tr class="company-row" 
                                            ...
                                            <td><?= $objCompanyData['apoderado'] ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
							        </tbody>
