							...
							<div class="widget-body no-padding">
                                ...
                                <table id="datatable_fixed_column" class="table table-striped table-bordered dataTable" width="100%">
                                    ...
                                    <thead>
                                        <tr class="header-cols-labels">
                                            ...
                                            <th class="<?= $sortBy && ('name' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="name">Title</th>
                                            <th class="<?= $sortBy && ('facturadora' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="facturadora">Empresa Facturadora</th>
                                            <th class="<?= $sortBy && ('content' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="content">Content</th>
                                ...
                                <?php if ( $arrCompaniesData ) { ?>
                                    <?php foreach( $arrCompaniesData as $objCompanyData ) { ?>
                                        <tr class="contacto-row" 
                                            ...
                                            <td><?= $objCompanyData['name'] ?></td>
                                            <td><?= $objCompanyData['facturadora'] ?></td>
                                            <td style="text-align:left"><?= base64_decode(substr($objCompanyData['content'],0, 100)).'....' ?></td>
                                        </tr>
                                    <?php } ?>
                                <?php } ?>
                                    </tbody>
                               ...
                               <div class="dt-toolbar-footer">
                                    ...
                                    <div class="col-sm-6 col-xs-12">
                                        ...
                                        <button class="btn btn-sm btn-default btn-detail-contacto">
