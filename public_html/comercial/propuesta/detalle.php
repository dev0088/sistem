...
/**********************************************  PAGE SPECIFICS  ************************************************/
	...
	$db->connect();
    $pageURL 	= APP_URL . 'comercial/propuesta/detalle.php';
	$page_nav["Comercial"]["sub"]["Propuestas"]["sub"]["Detalle propuesta"]["active"] 	= true;
	$breadcrumbs["Comercial"] = APP_URL . 'comercial/propuesta/home.php';
