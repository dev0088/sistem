<?php 
    ...
    $pageURL 		= APP_URL . 'comercial/propuesta/index.php';
	$breadcrumbs["Comercial"] = '';
    $page_nav["Comercial"]['sub']["Propuestas"]['sub']["Consultar"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-propuesta').on('click', function() {
            location.href = "<?= APP_URL ?>comercial/propuesta/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-view-propuesta').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>comercial/propuesta/home.php?contacto_id=" + selectedCompanyId + "&page=view<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
