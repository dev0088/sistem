<?php
	...
	$page_title = "Detalle Cio";
	$page_css[] = "wizard.css";
	$page_nav["Comercial"]["sub"]["Cio"]["sub"]["Detalle Cio"]["active"] = true;
	$breadcrumbs["Comercial"] 	= "";
	$breadcrumbs["Cio"] 		= "";
    $pageURL 	= APP_URL . 'comercial/cio/detalle.php';
	
	
	include("../../cio/process-detail.php");
	include("../../inc-2/header.php");
	include("../../inc-2/nav.php");
	include("../../cio/content-detail.php");
