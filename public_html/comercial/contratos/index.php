<?php 
    ...
    $pageURL 		= APP_URL . 'comercial/contratos/index.php';
	$breadcrumbs["Comercial"] = '';
    $page_nav["Comercial"]['sub']["Contratos"]["active"] 	= true;
    include ("../../contratos/process-index.php");
    include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
    include ("../../contratos/content-index.php");
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-contacto').on('click', function() {
            location.href = "<?= APP_URL ?>comercial/contratos/home.php?page=insert";
        });
        ...
        $('.btn-edit-contacto').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>comercial/contratos/home.php?contract_id=" + selectedCompanyId + "&page=edit";
            }
        });
        ...
        $('.btn-detail-contacto').on('click', function() {
            var 
                selectedCompanyId = $('.contacto-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>comercial/contratos/home.php?contract_id=" + selectedCompanyId + "&page=detail";
            }
        });
        ...
        $('.btn-remove-contacto').on('click', function() {
            ...
            if ( selectedCompanyId && confirm("Are you sure that you want to remove contract?") ) 
			{
                $('#contacto-details input[name="contract_id"]').val(selectedCompanyId);
