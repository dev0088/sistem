...
/**********************************************  PAGE SPECIFICS  ************************************************/
	...
	$db->connect();
    $pageURL 	= APP_URL . 'comercial/citas/detalle.php';
	$page_nav["Comercial"]["sub"]["Citas"]["sub"]["Detalle citas"]["active"] 	= true;
	$breadcrumbs["Comercial"] = APP_URL . 'comercial/citas/home.php';
    $page_title 			= "Detalle citas";
/**********************************************  PAGE SPECIFICS  ************************************************/
	include ("../../citas/process-detail.php");
    include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
	include ("../../citas/content-detail.php");
