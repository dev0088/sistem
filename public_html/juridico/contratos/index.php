<?php 
    ...
    $pageURL 		= APP_URL . 'juridico/contratos/index.php';
	$breadcrumbs["Juridico"] = '';
    $page_nav["Juridico"]['sub']["Contratos"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-contacto').on('click', function() {
            location.href = "<?= APP_URL ?>juridico/contratos/home.php?page=insert";
        });
        ...
        $('.btn-edit-contacto').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/contratos/home.php?contract_id=" + selectedCompanyId + "&page=edit";
            }
        });
        ...
        $('.btn-detail-contacto').on('click', function() {
            var 
                selectedCompanyId = $('.contacto-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/contratos/home.php?contract_id=" + selectedCompanyId + "&page=detail";
            }
        });
