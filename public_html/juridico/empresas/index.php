...
/**********************************************  PAGE SPECIFICS  ************************************************/
    ...
    $pageURL 			= APP_URL . 'juridico/empresas/index.php';
    $recordsPerPageLimit= 10;
	$breadcrumbs["Juridico"] = APP_URL . 'juridico/empresas/home.php';
    $page_nav["Juridico"]["sub"]["Empresas"]["active"] = true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-company').on('click', function() {
            location.href = "<?= APP_URL ?>juridico/empresas/home.php?page=insert";
        });
        ...
        $('.btn-view-company').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empresas/home.php?company_id=" + selectedCompanyId + "&page=detail";
            }
        });
        ...
        $('.btn-edit-company').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empresas/home.php?company_id=" + selectedCompanyId + "&page=edit";
            }
        });
        ...
        $('.btn-estatus-company').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empresas/home.php?company_id=" + selectedCompanyId + "&page=status";
            }
        });
        ...
        $('.btn-company-contactos').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/contactos/home.php?company_id=" + selectedCompanyId;
            }
        });
        ...
        $('.btn-company-citas').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/citas/home.php?company_id=" + selectedCompanyId;
            }
        });
        ...
        $('.btn-company-employees').on('click', function() {
            var 
                selectedCompanyId = $('.company-row.selected:first').data('companyId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empleados/home.php?company_id=" + selectedCompanyId;
            }
        });
