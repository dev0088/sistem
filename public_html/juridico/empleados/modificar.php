<?php
	...
	$breadcrumbs["Juridico"] = APP_URL . 'juridico/empresas/index.php';
	$breadcrumbs["Expedientes"] = '';
    $pageURL 		= APP_URL . 'juridico/empleados/modificar.php';
	$page_title 	= "Modificar expediente";
	$page_css[] 	= "wizard.css";
	$page_nav["Juridico"]["sub"]["Empleados"]["sub"]["Modificar expediente"]["active"] 	= true;
