<?php 
    ...
    $pageURL 		= APP_URL . 'juridico/empleados/index.php';
	$breadcrumbs["Juridico"] = '';
    $page_nav["Juridico"]['sub']["Empleados"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-employee').on('click', function() {
            location.href = "<?= APP_URL ?>juridico/empleados/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-employee').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empleados/home.php?employee_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
        ...
        $('.btn-view-employee').on('click', function() {
            var 
                selectedCompanyId = $('.employee-row.selected:first').data('employeeId');
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>juridico/empleados/home.php?employee_id=" + selectedCompanyId + "&page=view";
            }
        });
