...
/**********************************************  PAGE SPECIFICS  ************************************************/
    $pageURL 	= APP_URL . 'implementacion/contactos/modificar.php';
	$db 		= new Database(DB_SERVER, DB_USER, DB_PASS, DB_DATABASE);
	$db->connect();
	
	$page_title 			= "Modificar Contacto";
    $page_nav["Expedientes"]["sub"]["Contactos"]["sub"]["Modificar Contacto"]["active"] 	= true;
	$breadcrumbs["Implementación"] = '';
	$breadcrumbs["Contactos"] = APP_URL . 'implementacion/contactos/home.php';
