<?php 
    ...
    $pageURL 		= APP_URL . 'implementacion/contactos/index.php';
	$breadcrumbs["Implementación"] = '';
    $page_nav["Expedientes"]['sub']["Contactos"]["active"] 	= true;
    include ("../../contactos/process-index.php");
    include ("../../inc-2/header.php");
    include ("../../inc-2/nav.php");
    include ("../../contactos/content-index.php");
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-contacto').on('click', function() {
            location.href = "<?= APP_URL ?>implementacion/contactos/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-contacto').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>implementacion/contactos/home.php?contacto_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
