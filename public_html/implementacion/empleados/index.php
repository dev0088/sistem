<?php 
	...
	$pageURL 		= APP_URL . 'implementacion/empleados/index.php';
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-employee').on('click', function() {
            location.href = "<?= APP_URL ?>implementacion/empleados/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-edit-employee').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>implementacion/empleados/home.php?employee_id=" + selectedCompanyId + "&page=edit<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
