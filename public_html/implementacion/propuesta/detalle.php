...
/**********************************************  PAGE SPECIFICS  ************************************************/
	...
	$db->connect();
    $pageURL 	= APP_URL . 'implementacion/propuesta/detalle.php';
	$page_nav["Expedientes"]["sub"]["Propuestas"]["sub"]["Detalle propuesta"]["active"] 	= true;
	$breadcrumbs["Expedientes"] = APP_URL . 'implementacion/propuesta/home.php';
