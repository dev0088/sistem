<?php 
    ...
    $pageURL 		= APP_URL . 'implementacion/propuesta/index.php';
	$breadcrumbs["Propuestas"] = '';
    $page_nav["Expedientes"]['sub']["Propuestas"]['sub']["Consultar"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-propuesta').on('click', function() {
            location.href = "<?= APP_URL ?>implementacion/propuesta/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-view-propuesta').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>implementacion/propuesta/home.php?contacto_id=" + selectedCompanyId + "&page=view<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
