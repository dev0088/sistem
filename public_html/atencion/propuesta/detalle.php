...
/**********************************************  PAGE SPECIFICS  ************************************************/
	...
	$db->connect();
    $pageURL 	= APP_URL . 'atencion/propuesta/detalle.php';
	$page_nav["Atencion a Clientes"]["sub"]["Propuestas"]["sub"]["Detalle propuesta"]["active"] 	= true;
	$breadcrumbs["Atencion a Clientes"] = APP_URL . 'atencion/propuesta/home.php';
