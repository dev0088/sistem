<?php 
    ...
    $pageURL 		= APP_URL . 'atencion/propuesta/index.php';
	$breadcrumbs["Atencion a Clientes"] = '';
    $page_nav["Atencion a Clientes"]['sub']["Propuestas"]['sub']["Consultar"]["active"] 	= true;
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('.btn-add-propuesta').on('click', function() {
            location.href = "<?= APP_URL ?>atencion/propuesta/home.php?page=insert<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
        });
        ...
        $('.btn-view-propuesta').on('click', function() {
            ...
            if ( selectedCompanyId ) {
                location.href = "<?= APP_URL ?>atencion/propuesta/home.php?contacto_id=" + selectedCompanyId + "&page=view<?= isset($company_id) ? "&company_id=".$company_id : "" ?>";
            }
        });
