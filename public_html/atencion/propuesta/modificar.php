...
/**********************************************  PAGE SPECIFICS  ************************************************/
    $pageURL 	= APP_URL . 'comercial/contactos/modificar.php';
	$db 		= new Database(DB_SERVER, DB_USER, DB_PASS, DB_DATABASE);
	$db->connect();
	
	$page_title 			= "Modificar Contacto";
    $page_nav["Atencion a Clientes"]["sub"]["Contactos"]["sub"]["Modificar Contacto"]["active"] 	= true;
	$breadcrumbs["Atencion a Clientes"] = '';
	$breadcrumbs["Contactos"] = APP_URL . 'atencion/contactos/home.php';
