...
/*
var $server   = "http://72.249.68.21"; //database server
var $user     = "proyecto_userila"; //database login name
var $pass     = "Sw}u_yft!rOW"; //database login password
var $database = "proyecto_ila"; //database name

*/

var $server = "localhost";

var $user = "sistemam_user";

var $pass =  "wn-6j8=45C+o";

var $database = "sistemam_db";
