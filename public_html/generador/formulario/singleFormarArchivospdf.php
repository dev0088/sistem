...
// where l.id = $id
// ;");
        $empRes     = $conn->query("select name, subcategory_name, pmc_quantity_of_people, pmc_hours, pmc_cost, pmtot_cost from categories c 
...
$pdf = new PDF();
// Column headings
$header = array('Category', 'Sub-category', 'People', 'Hours', 'Price', 'Subtotal');
...
$pdf->Ln();
$pdf->Cell(140,12,"",1,0,'R',false);
$pdf->Cell(25,12,"TOTAL",1,0,'C',false);
$pdf->Cell(26,12, number_format($empRow1['alltotal'], 2),1,0,'C',false);
$pdf->Ln();
$pdf->Output();
