					...
					<div class="jarviswidget jarviswidget-color-darken" id="wid-id-1" data-widget-editbutton="false" data-widget-deletebutton="false">
						...
						<div>
							...
							<?php 
								...
								{ 
							?>
									<form  role="form" id="step-form" method="POST" action="insertar.php<?= isset($key_get) ? "?".$key_get : ""; ?>" enctype="multipart/form-data">
                                            ...
                                            ?>
												...
												<?php		
														...
														{ 
															...
															if(isset($fieldData['class']) && $fieldData['class'] != '') {
																$ist_class = $fieldData['class'];
															} else {
																$ist_class = '';
															}

															if(isset($fieldData['disabled']) && $fieldData['disabled'] != '') {
																if($fieldData['disabled'] == 'true') {
																	$ist_disable = 'disabled';
																}
															} else {
																$ist_disable = '';
															}
															...
															<div class="col-xs-<?= 12/$fieldData['col'] ?> col-sm-<?= 12/$fieldData['col'] ?> col-md-<?= 12/$fieldData['col'] ?> col-lg-<?= 12/$fieldData['col'] ?>">
																<div class="<?= (($fieldData['error'] != '') ? "form-group has-error" : "form-group"); ?>">
																	<div class="input-group">
																		...
																		<input type="<?= $fieldData['type'] ?>" class="form-control input-sm <?= $ist_class ?>" placeholder="<?= $fieldData['title'] ?>" title="<?= $fieldData['title'] ?>" name="<?= "{$currStepId}-{$fieldData['field']}" ?>" value="<?= $fieldData['value'] ?>" <?= $ist_disable ?>/>
																	</div>
