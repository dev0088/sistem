...
// echo "string";die();
    ...
    $crsno = $_POST["crsno"];
    $sql= "select l.id as lidd, name, subcategory_name, description, pmc_quantity_of_people, crsno, pmc_hours, pmc_cost, pmtot_cost, created_at from categories c 
