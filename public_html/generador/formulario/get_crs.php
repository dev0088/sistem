...
// echo "string";die();
    ...
    $crsno = $_POST["crsno"];
    $sql= "select l.id, name, subcategory_name, pmc_quantity_of_people, crsno, pmc_hours, pmc_cost, pmtot_cost, created_at from categories c 
