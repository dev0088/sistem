			...
			<!-- ** Campos de busqueda / Search fields -->
						...
						<!-- ** Campos de titulo de la columna --> 				
							            <tr class="header-cols-labels">
                                            <th class="<?= $sortBy && ('id' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="id">Número de CRS</th>
                                            

                                            <th class="<?= $sortBy && ('empresa' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="empresa">Empresa</th>
                                            
                                            
										   <th class="<?= $sortBy && ('nombre' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="nombre">Usuario</th>
                                            
                                            <th class="<?= $sortBy && ('id' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="id">%Avance</th>
                                           
                                            <th class="<?= $sortBy && ('email' == $sortBy['field']) ? ('asc' == $sortBy['order'] ? "sorting_asc" : "sorting_desc") : "sorting" ?>" data-field="email">Archivo generado</th>
							            </tr>
							        </thead>
                                ...
                                <?php if ( $arrEmployeesData ) { ?>
                                    <?php foreach( $arrEmployeesData as $objEmployeeData ) { ?>
                                        <tr class="employee-row" 
                                            ...
                                            <td><?= $objEmployeeData['facturadoras'].' - '.$objEmployeeData['suministradoras'] ?></td>
